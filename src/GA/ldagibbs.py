...
def main(*x, **r):
    ...
    lda1 = lda.LDA(n_topics=int(l[0]), alpha=l[1], eta=l[2], n_iter=500)

    lda1.fit_transform(tf)
    a=lda1.loglikelihood()
    return a
...
def main_another(*x, **r):

    base = '/share/aagrawa8/Data/results/'
    #base='/Users/amrit/GITHUB/Pits_lda/results/'
    path = os.path.join(base, 'tuned_GA_gibbs', r['file'], str(r['term']))
