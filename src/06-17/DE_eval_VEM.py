...
def _test(res=''):
    ...
    for lab in labels:
        ...
        temp={}
        for i in range(1,5):
            v, score,para_dict,gen = de.solve(main, pop, iterations=i, file=res, term=lab, data_samples=data_samples)
            temp[i]= score
        temp1[lab]= temp
    result[res] = temp1
    ...
    with open('dump/tuned_eval_gibbs'+res+'.pickle', 'wb') as handle:
