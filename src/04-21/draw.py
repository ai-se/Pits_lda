...
if __name__ == '__main__':
    ...
    file_data={'101pitsA_2.txt':{"tuned":[0.9, 0.6, 0.7, 0.4, 0.3],"untuned":[0.8,0.7,0.5,0.4,0.2] }, '101pitsB_2.txt':{"tuned":[0.9,0.9,0.8,0.8,0.55],"untuned":[0.7,0.7,0.6,0.6,0.4] },'101pitsC_2.txt':{"tuned":[0.9,0.9,0.9,0.9,0.9],"untuned":[0.9,0.7,0.6,0.5,0.4]},
               '101pitsD_2.txt':{"tuned":[0.9,0.9,0.9,0.9,0.8],"untuned":[0.9,0.8,0.8,0.8,0.7] },'101pitsE_2.txt':{"tuned":[0.9,0.9,0.7,0.5,0.65],"untuned":[0.8,0.8,0.7,0.5,0.4] },'101pitsF_2.txt':{"tuned":[0.9,0.9,0.6,0.6,0.5],"untuned":[0.8,0.8,0.7,0.55,0.4]}  }
    labels = [5, 6, 7, 8, 9]
    font = {'family' : 'normal',
            'weight' : 'bold',
            'size'   : 20}
