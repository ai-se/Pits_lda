...
def jaccard(a, file='', term=0):
    ...
    file_data = {}
    for file1 in fileB:
        with open("../../results/05-25/shuffle_" + file1, 'r') as f:
...
def get_top_words(model, feature_names, n_top_words, i=0, file1=''):
    filepath = "../../results/05-25/shuffle_" + file1
...
def _test_LDA(l, file=''):
    ...
    for j, file1 in enumerate(fileB):
        filepath1 = "../../results/05-25/shuffle_" + file1
    ...
    for file1 in fileB:
        ...
        for terms in labels:
            ...
            for i in range(5):
                ...
                # 2nd method
                # another_method()
                median1.append(jaccard(int(l[0]), file=file1, term=terms))
            print(median1)
            file_result[terms] = np.median(median1)
